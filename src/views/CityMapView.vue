...
<template>
  <section class="flex flex-col gap-4 fade-in lg:grid lg:grid-cols-[1fr_minmax(260px,320px)] lg:gap-5 lg:items-start">
    <div class="bg-white rounded-2xl p-4 border border-stone-200 shadow-sm space-y-2 lg:col-span-2">
      ...
      <button
        ...
        class="w-full text-left text-[11px] px-3 py-2 rounded-xl border transition lg:max-w-md"
    ...
    <div class="space-y-3 lg:sticky lg:top-4">
      ...
      <button
        ...
        class="text-xs text-stone-400 hover:text-stone-600 underline text-center py-2 w-full"
      >
